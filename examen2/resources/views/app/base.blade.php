...
<html>
    ...
    <body class="bg-light">
        <nav class="navbar navbar-expand-sm navbar-dark justify-content-center fixed-top" style="background-color: green">
        ...
        </nav> <a class="navbar-brand"  href="{{ url('') }}" style="background-color: green"></a>
        @yield('modalContent')
        <main>
            <div class="p-4  " style="background-color: green">
                <h4 class="display-4 text-white margin-left">{{ $title ?? 'Forüüm' }}</h4>
            </div>
