...
@section('content')
<label class="ml-5 mt-5 text-black" style="font-size:20px;">Message:</label>
...
<label class="ml-5 mt-5 text-black" style="font-size:20px;">Comments:</label>
    ...
    <div>
        <form action="{{ url('mycomment') }}" method="post">
            ...
            <div class="form-group">
                <label for="mensaje" class="text-black ml-5 mt-5">Comment</label>
